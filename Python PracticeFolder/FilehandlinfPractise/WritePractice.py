#
filename = "C:\\Users\\otr17\\PycharmProjects\\PythonCourse\\Python PracticeFolder\\FilehandlinfPractise\\writefile.txt"
...
#     lines = f.read()
# lines = lines.replace('hello', 'hi')  # replace string
# with open(filename, 'w') as f:
#     f.write(lines)
